...
function cliPerformImport( $data )
{
  ...
  if ( empty( $import ) ) {
    showWarningJson( ['status' => 0, 'message' => "Cannot import {$data['uuid']}.zip file"], 1 );
  }
  ...
  showWarningJson( ['status' => 1, 'message' => 'Import installed', 'uuid' => $data['uuid']], 1 );
}
